...
function imgui.OnDrawFrame()
  ...
  if second_window.v then
    ...
    if obnova.v then
                local iScreenWidth, iScreenHeight = getScreenResolution()
                imgui.SetNextWindowPos(imgui.ImVec2(iScreenWidth / 2, iScreenHeight / 2), imgui.Cond.FirstUseEver, imgui.ImVec2(7, 3))
                imgui.Begin(u8 'Обновление 2.9.3', obnova, imgui.WindowFlags.NoResize, imgui.WindowFlags.NoCollapse)
				imgui.BeginChild("Обновление 2.9.3", imgui.ImVec2(490, 250), true, imgui.WindowFlags.VerticalScrollbar)
