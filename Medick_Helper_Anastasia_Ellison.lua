...
function imgui.OnDrawFrame()
  ...
  if second_window.v then
    ...
    if obnova.v then
				...
				imgui.BulletText(u8 '2.Добравлены новые лекции и методы лечения.')
				imgui.BulletText(u8 '3.Доработаны задержки.')
				imgui.BulletText(u8 '4.Добавлена команда /cchat для очистки чата.')
				imgui.BulletText(u8 '5.Добавлен автоскрин invite, uninvite, giverank.')
                imgui.Separator()
