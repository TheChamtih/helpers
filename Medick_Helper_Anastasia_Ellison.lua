...
function imgui.OnDrawFrame()
  ...
  if second_window.v then
    ...
    if obnova.v then
				...
				imgui.BulletText(u8 '1.Удалено проктически все что связнано с Instructors Helper.')
				...
				imgui.BulletText(u8 '2.Переделана команда /sethud(при перемещение худа число вылеченых сбивается)')
				imgui.Separator()
