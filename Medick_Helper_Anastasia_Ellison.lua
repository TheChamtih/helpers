 ...
 return
{
   ...
   title = "{80a4bf}»{FFFFFF} Начало собеседования:",
	...
	sampSendChat("/d OG,вещаю")
        wait(cfg.commands.zaderjka * 4000)
...
{
  {
  ...
  },
   {
    ...
    onclick = function()
        ...
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat('/b /rr [SOMM] Выезжаю на пост "Мэрия". Напарник - ".."')
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat('/b /rr [SOMM] Докладываю пост "Мэрия" Вылечено 0 | Вызовов 0 | Справок 0 | Сеансов 0.')
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat('/b /rr [SOMM] Покинул пост "Мэрия" по причине: "..."')
        wait(cfg.commands.zaderjka * 4000)
  ...
  },
  {
   ...
   },
   {
	...
	sampSendChat("Приветствую Вас в Министерстве Здравоохранения.")
        ...
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat('А именно MA, о работе их Вы познакомитесь на оф портале. ')
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat('Задача-оказание врачебной помощи пациентам, работа на постах и патрулях. ')
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat("Во время нахождении на работе носим свой бейджики 15. ")
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat("/b /clist 15 - ваш бейджик, бейджики надеваем строго по РП! Вам выдали рацию, которую вы должны настроить на волну МЗ.")
        wait(cfg.commands.zaderjka * 4000)
        sampSendChat("/b /r [MA] - ваш ТЭГ. ")
        wait(cfg.commands.zaderjka * 4000)
...
function imgui.OnDrawFrame()
  ...
  if second_window.v then
    ...
    if obnova.v then
				...
				imgui.BulletText(u8 '4.Добавлена команда /cchat для очистки чата.')
                imgui.Separator()
	...
	if helps.v then
				...
				imgui.BulletText(u8 '/cchat - Очистить чат')
				imgui.Separator()
